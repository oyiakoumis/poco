...
class BaseDocument(BaseModel):
    ...
    id: Optional[PydanticUUID] = Field(default_factory=uuid4, alias="_id", description="Unique identifier for the document")
    user_id: str = Field(description="Identifier of the user who owns this document")
