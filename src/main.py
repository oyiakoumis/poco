...
def main() -> None:
    database_connector = DatabaseConnector(DATABASE_CONNECTION_STRING, "task_manager")
    ...
    initial_message = HumanMessage(content="Create a table to store my todos")
    print_message(initial_message, "Human")
